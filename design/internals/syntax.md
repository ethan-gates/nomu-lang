...
- **Operators** — the shipped set and its precedence:
  ...
  - Open: grouping parentheses `(a + b)` do not parse yet (`plans/tasks/114-grouping-parens.md`); operator overloading via interface conformance is deferred (`generics.md` §10).
