...
AST macros are the powerful, well-understood model. Hygiene keeps generated names from colliding with user names. Built last (roadmap M8, `roadmap.md`) — the core language is complete before macros arrive.
...
- **Surface syntax** — deferred with the rest of the macro work to M8 (`roadmap.md`).
