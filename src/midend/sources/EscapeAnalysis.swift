import noir
import support
// Conservative, intra-procedural escape analysis on NOIR (design: memory-model.md §6.1).
//
...
// scope for this phase (memory-model.md §6.1). The analysis is intra-procedural — a value that is returned,
