// The fixed runtime floor for emitted C: the runtime preamble and the C entry
// point. Not derived from the IR — CodegenIR splices these in verbatim.
public enum NomuRuntime {
    static let preamble = """
